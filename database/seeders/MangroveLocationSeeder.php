...
/**
 * MangroveLocationSeeder - 25 Titik Monitoring Mangrove DKI Jakarta
 *
 * Distribusi:
...
Sonneratia alba',
        ...
        // 8. Mangrove STIP
        $this->createFullLocation([
            'name'             => 'Mangrove Sekolah Tinggi Ilmu Pelayaran (STIP)',
            'latitude'         => -6.102483,
            'longitude'        => 106.955146,
            'area'             => 4.6,
            'density'          => 'jarang',
            'type'             => 'pengkayaan',
            'region'           => 'Cilincing',
...
Xylocarpus moluccensis',
        ...
        // 14. Pulau Tidung Besar
        $this->createFullLocation([
            'name'             => 'Pulau Tidung Besar',
            'latitude'         => -5.803620,
            'longitude'        => 106.520160,
            'area'             => 1.43,
            'density'          => 'jarang',
            'type'             => 'rehabilitasi',
            'region'           => 'kepulauan seribu selatan',
            'location_address' => 'Pulau Tidung Besar, kepulauan seribu selatan, Jakarta Utara',
            'manager'          => 'DKPKP',
            'year_established' => 2025,
            'health_percentage' => 100,
            'health_score'     => 'NAK: 5.6',
            'description'      => 'Titik pengamatan berada di Pulau Tidung Besar, aktivitas yang teramati: pengelola mangrove dan pengunjung.',
...
Rhizophora stylosa',
        ...
        // 15. Pulau Tidung Kecil
        $this->createFullLocation([
            'name'             => 'Pulau Tidung Kecil',
            'latitude'         => -5.802492,
            'longitude'        => 106.523059,
            'area'             => 1.43,
            'density'          => 'jarang',
            'type'             => 'rehabilitasi',
            'region'           => 'kepulauan seribu selatan',
            'location_address' => 'Pulau Tidung Kecil, kepulauan seribu selatan, Jakarta Utara',
            'manager'          => 'DKPKP',
            'year_established' => 2025,
            'health_percentage' => 100,
            'health_score'     => 'NAK: 5.6',
...
Nipah',
        ...
        // 18. Titik 1 Ekowisata Mangrove PIK
        $this->createFullLocation([
            'name'             => 'Titik 1 Ekowisata Mangrove PIK',
            'latitude'         => -6.1223,
            'longitude'        => 106.7551,
            'area'             => 6,
            'density'          => 'lebat',
            'type'             => 'dilindungi',
            'region'           => 'Penjaringan',
            'location_address' => 'Titik 1 Ekowisata Mangrove PIK, Penjaringan, Jakarta Utara',
            'manager'          => 'Dinas Pertamanan dan Hutan Kota',
            'year_established' => 2024,
            'health_percentage' => 79.4,
            'health_score'     => 'NAK: 6.7',
...
Pidada',
            ...
            'programs'           => [
                'Penanaman mangrove',
                'Penyedia lahan mangrove',
                'Penyedia bibit mangrove',
                'Edukasi mangrove',
            ],
            'stakeholders'       => [
                'AEON',
        ...
        // 19. Titik 2 Ekowisata Mangrove PIK
        $this->createFullLocation([
            'name'             => 'Titik 2 Ekowisata Mangrove PIK',
            'latitude'         => -6.122018,
            'longitude'        => 106.755432,
            'area'             => 7,
            'density'          => 'lebat',
            'type'             => 'dilindungi',
            'region'           => 'Penjaringan',
            'location_address' => 'Titik 2 Ekowisata Mangrove PIK, Penjaringan, Jakarta Utara',
            'manager'          => 'Dinas Pertamanan dan Hutan Kota',
            'year_established' => 2024,
            'health_percentage' => 72.9,
            'health_score'     => 'NAK: 6.8',
            'description'      => 'Titik pengamatan dekat dengan jalan tol dan pemukiman sehingga aktivitas di sekitarnya didominasi oleh pedagang, pemancing, pengunjung, dan petugas kawasan.',
            'species'          => 'Avicennia sp.,
Rhizophora sp.,
...
Nyamplung',
        ...
        // 21. Komunitas Mangrove Muara Angke
        $this->createFullLocation([
            'name'             => 'Komunitas Mangrove Muara Angke (KOMMA)',
            'latitude'         => -6.101396,
            'longitude'        => 106.767583,
            'area'             => 2.3,
            'density'          => 'lebat',
            'type'             => 'pengkayaan',
            'region'           => 'Penjaringan',
            ...
            'description'      => 'Berada di kawasan pemukiman, akses dan fasilitas sulit, banyak sampah dari laut dan limbah domestik yang masuk ke wilayah mangrove',
            'species'          => 'Avicennia sp.,
Rhizophora sp.,
Nipah,
Pidada',
        ...
        // 22. Suaka Margasatwa Muara Angke
        $this->createFullLocation([
            'name'             => 'Suaka Margasatwa Muara Angke',
            'latitude'         => -6.114939,
            'longitude'        => 106.768516,
            'area'             => 25,
            'density'          => 'sedang',
            'type'             => 'pengkayaan',
            'region'           => 'Penjaringan',
...
Cemara laut',
        ...
        $this->command->info('✅ Berhasil seed 25 lokasi monitoring mangrove!');
        $this->displaySummary();
    }
