...
@section('content')
    ...
    <section class="py-12 md:py-16 lg:py-20">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-start">
                {{-- Left Content --}}
                <div>
                    <p class="text-muted text-sm md:text-base mb-2">Dinas Lingkungan Hidup DKI Jakarta</p>
                    <h1 class="text-3xl md:text-4xl lg:text-5xl font-bold text-secondary leading-tight mb-6">
                        Sistem Informasi dan Komunikasi<br>
            ...
            <div class="lg:text-left flex flex-col items-start lg:items-end">
                <p class="text-muted text-sm md:text-base mb-6 max-w-md">
                    Sikomang hadir sebagai platform pemantauan dan strategi pengendalian
                    kerusakan ekosistem mangrove di DKI Jakarta.
                </p>
                ...
                <div class="flex flex-wrap gap-3">
                    ...
                    <a
                        ...
                        class="inline-flex items-center space-x-2 bg-primary text-white px-6 py-3 rounded-lg font-semibold hover:bg-primary-dark transition-all"
                    >
                        <span>SIKOMANG</span>
                        {{-- Globe Icon --}}
    ...
    <section class="py-12 md:py-16 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-8 md:mb-12">
                <p class="text-muted text-sm mb-1">Postingan</p>
                <h2 class="text-2xl md:text-3xl lg:text-4xl font-bold text-secondary">Artikel Terkini</h2>
            </div>
            ...
            <div class="text-center mt-10">
                <a
                    ...
                    class="inline-flex items-center space-x-2 border-2 border-primary text-primary px-6 py-3 rounded-lg font-semibold hover:bg-primary hover:text-white transition-all"
                >
        ...
        <div class="fixed inset-0 flex items-center justify-center p-4">
            <div class="bg-white rounded-2xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto relative animate-modal">
                ...
                <div class="flex items-center justify-between p-6 pb-4">
                    <h2 class="text-2xl md:text-3xl font-bold text-secondary">Tentang Sikomang</h2>
                    <button
                        type="button"
                        onclick="closeModal()"
    ...
    {{-- <section class="py-16 md:py-24">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="hero-gradient rounded-3xl p-8 md:p-12 lg:p-16 text-center">
                <h2 class="text-2xl md:text-3xl lg:text-4xl font-bold text-white mb-4">
                    Mari Bersama Menjaga Ekosistem Mangrove
                </h2>
                <p class="text-white/80 max-w-2xl mx-auto mb-8">
                    Bergabunglah dengan komunitas kami untuk berpartisipasi dalam kegiatan pelestarian dan pemantauan ekosistem mangrove di DKI Jakarta.
                </p>
                <div class="flex flex-col sm:flex-row gap-4 justify-center">
                    <a
                        href="#"
                        class="inline-flex items-center justify-center space-x-2 bg-white text-primary px-6 py-3 rounded-lg font-semibold hover:bg-gray-100 transition-all"
                    >
                        <span>Gabung Komunitas</span>
                    </a>
                    <a
                        href="#"
                        class="inline-flex items-center justify-center space-x-2 border-2 border-white text-white px-6 py-3 rounded-lg font-semibold hover:bg-white/10 transition-all"
                    >
                        <span>Pelajari Lebih Lanjut</span>
                    </a>
                </div>
