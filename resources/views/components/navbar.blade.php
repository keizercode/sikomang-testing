    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center h-16 md:h-20">
            ...
            <a href="{{ route('home') }}" class="flex items-center space-x-3">
                ...
                <div class="flex h-[49px] items-center justify-center relative shrink-0 w-[0px]"><div class="flex-none rotate-[90deg]"><div class="h-0 relative w-[49px]"><div class="absolute bottom-0 left-0 right-0 top-[-1px]" style="--stroke-0: rgba(216, 217, 217, 1);"><svg class="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 49 1"><line id="Line 1" stroke="var(--stroke-0, #D8D9D9)" x2="49" y1="0.5" y2="0.5"></line></svg></div></div></div></div>

                <div class="hidden sm:block">
                    <h1 class="text-lg font-bold text-navbar">SIKOMANG</h1>
                    <p class="text-xs text-muted leading-tight">Sistem Informasi dan Komunikasi<br>Mangrove DKI Jakarta</p>
                </div>
            </a>
        ...
        <div class="md:hidden hidden pb-4" id="mobile-menu">
            <div class="flex flex-col space-y-3">
                <a href="{{ route('marketplace') ?? '#' }}" class="flex items-center space-x-2 px-3 py-2 rounded-lg hover:bg-gray-100">
                    <svg class="w-5 h-5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M3 9L12 2L21 9V20C21 20.5304 20.7893 21.0391 20.4142 21.4142C20.0391 21.7893 19.5304 22 19 22H5C4.46957 22 3.96086 21.7893 3.58579 21.4142C3.21071 21.0391 3 20.5304 3 20V9Z" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                    </svg>
                    <span class="font-medium">Marketplace</span>
                </a>
                <a href="{{ route('komunitas') ?? '#' }}" class="flex items-center space-x-2 px-3 py-2 rounded-lg hover:bg-gray-100">
                    <svg class="w-5 h-5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M17 21V19C17 17.9391 16.5786 16.9217 15.8284 16.1716C15.0783 15.4214 14.0609 15 13 15H5C3.93913 15 2.92172 15.4214 2.17157 16.1716C1.42143 16.9217 1 17.9391 1 19V21" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                    </svg>
                    <span class="font-medium">Komunitas</span>
                </a>
                <a href="{{ route('edukasi') ?? '#' }}" class="flex items-center space-x-2 px-3 py-2 rounded-lg hover:bg-gray-100">
                    <svg class="w-5 h-5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M2 3H8C9.06087 3 10.0783 3.42143 10.8284 4.17157C11.5786 4.92172 12 5.93913 12 7V21C12 20.2044 11.6839 19.4413 11.1213 18.8787C10.5587 18.3161 9.79565 18 9 18H2V3Z" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                    </svg>
                    <span class="font-medium">Edukasi</span>
